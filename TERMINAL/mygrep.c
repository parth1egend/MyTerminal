    ...
    else
    {
        ...
        while (fgets(line, 1000, file))
        {
            ...
            while (match != NULL)
            {
                ...
                if (show_line_numbers && (match_whole_word_only == 1 && word_only == 1)&& count_matches_only == 0)
                {
                    printf("%d:", line_number);
                }
                if (show_line_numbers && (match_whole_word_only == 0)&& count_matches_only == 0)
                {
                    printf("%d:", line_number);
                }
                ...
                if (ignore_case)
                {
                    match = strcasestr(match + strlen(cmdarray[pattern_index]), cmdarray[pattern_index]);
                }
                else
                {
                    match = strstr(match + strlen(cmdarray[pattern_index]), cmdarray[pattern_index]);
                }
